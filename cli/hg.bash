...
script="erl -pa ebin -noshell -eval \"handleCLIRequest:"
...
if [ "$1" == "join" ]; then
    ...
    if [ "$#" != 2 ]; then
        ...
        echo "Available Games:" # TODO: the next command should be an ls of the directory holding the games (or something similar)
        exit 1
    fi
